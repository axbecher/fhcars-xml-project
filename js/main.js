    ...
    if(document.getElementById("menuNavigation")){
        ...
        <li><a href="./index.html">Home</a></li>
                                    <li ><a href="#">Queries <span class="arrow_carrot-down"></span></a>
                                        <ul class="dropdown">
                                            <li><a href="./queries/query1.html">Query 1</a></li>
                                            <li><a href="./queries/query2.html">Query 2</a></li>
                                            <li><a href="./queries/query3.html">Query 3</a></li>
                                            <li><a href="./queries/query4.html">Query 4</a></li>
                                            <li><a href="./queries/query5.html">Query 5</a></li>
                                            <li><a href="./queries/query6.html">Query 6</a></li>
                                            <li><a href="./queries/query7.html">Query 7</a></li>
                                            <li><a href="./queries/query8.html">Query 8</a></li>
                                            <li><a href="./queries/query9.html">Query 9</a></li>
                                            <li><a href="./queries/query10.html">Query 10</a></li>
