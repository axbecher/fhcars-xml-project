...
Toate masinile pe care le poti lua doar din Autoshow, au peste 200 cai putere si 
    pretul peste 100,000, ordonate in functie de caii putere, descrescator
...
{
for $x in $objects
where $x/car_source = 'Autoshow' and $x/Horse_Power > '200' and $x/In_Game_Price > '100,000'
order by $x/Horse_Power descending
